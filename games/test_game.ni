...
The kitchen part 1 is some text that varies. The kitchen part 1 is " refrigerator, which looks usual, is close by.[if c_2 is open and there is something in the c_2] The refrigerator contains [a list of things in the c_2]. The light flickers for a second, but nothing else happens.[end if]".
...
The kitchen part 5 is some text that varies. The kitchen part 5 is " If you haven't noticed it already, there seems to be something there by the wall, it's a stove. I guess it's true what they say, if you're looking for a stove, go to TextWorld. [if there is something on the s_2]You see [a list of things on the s_2] on the stove.[end if]".
...
The kitchen part 7 is some text that varies. The kitchen part 7 is " You can make out a kitchen island. The kitchen island is ordinary.[if there is something on the s_3] On the kitchen island you can make out [a list of things on the s_3].[end if]".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "Of every bedroom you could have walked into, you had to come round a normal one. You begin to take stock of what's here.
...
The bedroom part 3 is some text that varies. The bedroom part 3 is " Oh wow! Is that what I think it is? It is! It's an antique trunk.[if c_1 is open and there is something in the c_1] The antique trunk contains [a list of things in the c_1].[end if]".
...
The bedroom part 5 is some text that varies. The bedroom part 5 is " You make out a king-size bed. [if there is something on the s_0]On the king-size bed you see [a list of things on the s_0], so there's that.[end if]".
...
The backyard part 1 is some text that varies. The backyard part 1 is "[if there is nothing on the s_10] But the thing is empty, unfortunately. You move on, clearly depressed by TextWorld.[end if]".
The backyard part 2 is some text that varies. The backyard part 2 is " You see a bbq. You shudder, but continue examining the bbq. The bbq is ordinary.[if there is something on the s_8] On the bbq you see [a list of things on the s_8].[end if]".
The backyard part 3 is some text that varies. The backyard part 3 is "[if there is nothing on the s_8] But the thing is empty. You think about smashing the bbq to bits, throwing the bits in a fire, etc, until you get bored.[end if]".
The backyard part 4 is some text that varies. The backyard part 4 is " Look over there! a patio table. [if there is something on the s_9]You see [a list of things on the s_9] on the patio table. Something scurries by right in the corner of your eye. Probably nothing.[end if]".
...
The living room part 2 is some text that varies. The living room part 2 is " As if things weren't amazing enough already, you can even see a low table. [if there is something on the s_6]You see [a list of things on the s_6] on the low table. You can't wait to tell the folks at home about this![end if]".
...
The living room part 4 is some text that varies. The living room part 4 is " Oh, great. Here's a tv. The tv is ordinary.[if there is something on the s_7] On the tv you can make out [a list of things on the s_7].[end if]".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "Okay, so you're in a bathroom, cool, but is it ordinary? You better believe it is. You can barely contain your excitement.
 ...
 Oh wow! Is that what I think it is? It is! It's a toilet.[if c_3 is open and there is something in the c_3] The toilet contains [a list of things in the c_3]. Huh, weird.[end if]".
